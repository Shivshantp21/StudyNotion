    ...
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        <div className="my-6 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="form-style  text-richblack-900 py-1 px-2"
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="dob" className="lable-style text-richblack-5">
                Date of Birth
              </label>
              <input
                type="date"
                name="dob"
                id="dob"
                className="form-style  text-richblack-900 px-2"
                {...register("dob", {
                  required: {
                    value: true,
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <select
                ...
                name="gender"
                id="gender"
                className="form-style  text-richblack-900 px-2 py-1"
